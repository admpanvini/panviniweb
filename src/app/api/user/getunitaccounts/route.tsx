...
import { get_unit_accounts } from "@/utils/db_queries/get_unit_accounts";
...
export async function POST(req: Request) {
  try {
    ...
    const datos_cliente=await get_unit_accounts(id_cuenta)
    console.log("CUentassss,",datos_cliente)
